...
def compute(X, Y, u_n, v_n, eta_n, u_np1, v_np1, alpha, beta_c, u_list, v_list, eta_list):
...
def writeToFile(data):
    np.savetxt("outputFile1.txt", data)
...
def main():
    ...
    info = compute(X, Y, u_n, v_n, eta_n, u_np1, v_np1, alpha, beta_c, u_list, v_list, eta_list)
